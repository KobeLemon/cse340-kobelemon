-- AFTER YOU RUN THESE "db-sql-code.sql" STATEMENTS, ALWAYS RUN THE "assignment2-sql" STATEMENTS

-- This creates the ENUM type
...
-- This creates the classification table if it does not already exist
...
-- This creates the inventory table if it does not already exist
...
-- This creates the account table if it does not already exist
...
-- This inserts the five classifications of vehicles into the classifications table
...
VALUES (
    ...
    '/images/model-t-truck.jpg',
    '/images/model-t-truck-tn.jpg',
    30000,
    26357,
    'Black',
    5
